...
(function() {
    ...
    document.write("<link rel='stylesheet' type='text/css' href='" + protocol + "//csdnimg.cn/pubfooter/css/pub_footer_1.0.3.css?v=201810222345'/>");
    ...
    function changeImg(){
        var newItem = '<div class="img-box"><a href="https://bbs.csdn.net/forums/Service?utm_source=csdn_footer" target="_blank"><img src="https://csdnimg.cn/pubfooter/images/csdn_cs_qr.png" alt="微信客服" style="padding: 6px;"></a><p class="app-text">微信客服</p></div>'
      newItem += '<div class="img-box fr"><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDE4MDEwNl80ODc3MzVfODAwMTgwMTA2XzJf" target="_blank"><img style="padding:6px;" src="https://csdnimg.cn/pubfooter/images/csdn-kf.png" alt="QQ客服"></a><p class="app-text">QQ客服</p></div>'
        // if(storage.getItem('randomN') === '0'){
        //     newItem += '<div class="img-box fr"><a href="https://blog.csdn.net/Blockchain_lemon?utm_source=csdn_footer" target="_blank"><img style="padding:6px;" src="//csdnimg.cn/pubfooter/images/csdn-qkl.png" alt="区块链大本营"></a><p class="app-text">区块链大本营</p></div>'
        //     storage.setItem("randomN", '1');
        // }else if(storage.getItem('randomN') === '1'){
        //     newItem += '<div class="img-box fr" ><a href="https://www.csdn.net/app/?utm_source=csdn_footer" target="_blank"><img  src="https://csdnimg.cn/pubfooter/images/app.png" alt="下载CSDN APP" style="padding:6px"></a><p class="app-text">下载CSDN APP</p></div>'
        //     storage.setItem("randomN", '2');
        // }else if(storage.getItem('randomN') === '2'){
        //     newItem += '<div class="img-box fr"><a href="https://blog.csdn.net/csdnnews?utm_source=csdn_footer" target="_blank"><img  src="//csdnimg.cn/pubfooter/images/csdn-zx.png" alt="官方公众号" style="padding: 6px;"></a><p class="app-text">官方公众号</p></div>'
        //     storage.setItem("randomN", '0');
        // }
        $(document).find('#footer-contact-box').html(newItem)
    }
